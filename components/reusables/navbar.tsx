...
export default function Navbar() {
	return (
		<div className="w-full border-2 border-primary rounded-md  h-12 flex items-center justify-between px-4 shadow-sm mt-4">
			<Link href="/" className="flex gap-2 flex-row items-center text-primary">
				<svg
